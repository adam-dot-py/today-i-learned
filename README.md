...
> :tada: There are 369 entries so far!
...
- [Dataframes to tuples](/Pandas/dataframes_to_tuples.md)
...
- [Combining columns in a dataframe where null](Pandas/combine-columns-in-a-dataframe.md)
...
- [Perform SQL queries on a Spark dataframe](/Spark/perform-sql-on-spark-dataframes)
...
- [Subtract previous row](/SQL/subtract-previous-row.md)
- [Update array values](SQL/update-array-values.md)
- [Update columns in a table](/SQL/update-columns-in-a-table.md)
